...
public class SocketHandler {
	...
	public void sendProtocolIsReadyNotification(EventData eventData, List<UserData> list)
	{
		list.forEach(l->{
			SocketIOClient sock = connections.get(l.getEmail());
			if(sock != null)
				sendToClient(sock, "Notification", new ProtocolReadyNotificationData(eventData));
		});
	}
